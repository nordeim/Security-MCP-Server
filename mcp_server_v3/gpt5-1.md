### Plan for a complete, drop-in replacement
...
- **HTTP endpoints and models:** The FastAPI endpoints, models, metrics, and SSE are preserved as-is, ensuring drop-in compatibility with existing operations.
