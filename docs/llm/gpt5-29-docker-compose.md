...
- • Grace period alignment: If you want Docker to wait longer before sending SIGKILL, set a Compose-level stop_grace_period that mirrors your MCP_SERVER_SHUTDOWN_GRACE_PERIOD:
